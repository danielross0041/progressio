<aside class="sidebar">
                <div class="scrollbar-inner">
                    ...
                    <ul class="navigation">
                        ...
                        <li class="{{isset($freeseminars_ytmenu)?'navigation__active':''}}"><a href="{{url('adminiy/listing/freeseminars-listing')}}"><i class="zmdi zmdi-book zmdi-hc-fw"></i> Free Seminars</a></li>
						<li class="{{isset($tutor_quiz_questions_ytmenu)?'navigation__active':''}}"><a href="{{url('adminiy/listing/tutor_quiz_questions-listing')}}"><i class="zmdi zmdi-assignment zmdi-hc-fw"></i> Tutor Quiz Questions</a></li>
						<li class="{{isset($adminiy_tutor_meeting_admin)?'navigation__active':''}}"><a href="{{route('adminiy.tutor_meeting_admin')}}"><i class="zmdi zmdi-alarm zmdi-hc-fw"></i> Tutor Meetings</a></li>
						<li class="{{isset($anualreports_ytmenu)?'navigation__active':''}}"><a href="{{url('adminiy/listing/anualreports-listing')}}"><i class="zmdi zmdi-file-text zmdi-hc-fw"></i> Annual Reports for Schools</a></li>
                        ...
                        <li class="navigation__sub {{in_array($currentMenu,$underMenuActive)?'navigation__sub--active navigation__sub--toggled flag_here':''}}">
                            <a href="javascript:void(0)"><i class="zmdi zmdi-accounts zmdi-hc-fw"></i><span data-toggle="tooltip" title="From here you can manage all of your Teachers, School Admins, Pupils, Tutors">Manage Users</span></a>
                            <ul>
                                <li class="school_menu"><a href="{{url('adminiy/listing/users-listing#user_type=0')}}">Schools</a></li>
                                <li class="teacher_menu"><a href="{{url('adminiy/listing/users-listing#user_type=1')}}">Teachers</a></li>
                        ...
                        <li class="navigation__sub {{in_array($currentMenu,$underMenuActive)?'navigation__sub--active navigation__sub--toggled flag_here':''}}">
                            ...
                            <ul>
                                <li class="TUTORUNIVERSITIES_flag"><a href="{{url('adminiy/listing/m_flag-listing#flag_type=TUTORUNIVERSITIES')}}">Tutor Universities</a></li>
                                <li class="SUBJECTS_flag"><a href="{{url('adminiy/listing/m_flag-listing#flag_type=SUBJECTS')}}">Subjects</a></li>
                            </ul>
                        </li>
                        
                        <li class="{{Route::currentRouteName()=='adminiy.bookinglisting'?'navigation__active':''}}"><a href="{{route('adminiy.bookinglisting')}}"><i class="zmdi zmdi-home"></i> Booking Reports of Tutor</a></li>

                        <li class="navigation__sub {{Route::currentRouteName()=='adminiy.listing'?'navigation__sub--active navigation__sub--toggled flag_here':''}}">
                            <a href="javascript:void(0)"><i class="zmdi zmdi-accounts zmdi-hc-fw"></i><span data-toggle="tooltip" title="From here you can manage all of your Teachers, School Admins, Pupils, Tutors">Manage Users</span></a>
                            <ul>
                                <li class="school_menu "><a href="{{url('adminiy/profile-listing/1')}}">Schools</a></li>
                                <!-- <li class="teacher_menu"><a href="{{url('adminiy/profile-listing/2')}}">Teachers</a></li> -->
                                <!-- <li class="sides_product"><a href="{{url('adminiy/listing/products-listing#product_type=sides')}}">Sides</a></li>
                                <li class="desserts_product"><a href="{{url('adminiy/listing/products-listing#product_type=desserts')}}">Desserts</a></li>
                                <li class="drinks_product"><a href="{{url('adminiy/listing/products-listing#product_type=drinks')}}">Drinks</a></li>
                                <li class="deals_product"><a href="{{url('adminiy/listing/products-listing#product_type=deals')}}">Deals</a></li> -->
