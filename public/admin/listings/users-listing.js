...
if(window.location.hash){
    usertype = parseInt(window.location.hash.replace('#user_type=',''))
    if(usertype==0){
        _menuactive='school_menu';
        header='Schools'
        _firstcol='School '
    }
    if(usertype==1){
        _menuactive='teacher_menu';
        header='Teachers'
        _firstcol='Teacher '
    }
}
...
document.getElementsByClassName(_menuactive)[0].classList = 'navigation__active';
(async () => {
