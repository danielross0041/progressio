const tablename='tutor_quiz_questions';const ydebugger=false; var ytabled;
...
(async () => {
    ...
    */
    ...
    [
        ...
        'viewFast',
        'delete',
		'<button onclick="addanswers(this)" data-toggle="tooltip" class="btn btn-outline-warning btn--icon" data-placement="top" title="" data-original-title="Add Answers"><i class="zmdi zmdi-plus zmdi-hc-fw"></i></button>'
    ],'.ytable',{
        "where":{
            "is_active":"IN('0','1')",
            //"is_active":"='1'",
...
function addanswers(obj){
	...
	window.location.href=base_url('adminiy/answers/'+id);
}
