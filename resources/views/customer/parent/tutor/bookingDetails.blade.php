            ...
            <div class="col-md-12 pt-5 pb-5">
                <div class="dashborad_main_sec">
                    ...
                    <div id="tutorbookingapp" class="upcoming_lesson_tab">
                        <form id="finalizeBookingForm" method="POST" action="{{route('parent.tutor.schedule.finalizeBooking')}}">
                            @csrf @foreach($data['pupils'] as $dat) @php $pupil = App\Model\User::find($dat); $subject = Helper::returnFlag($data['subject_id']); @endphp
                            <div class="row mb-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea
                                        ...
                                        rows="12"
                                        cols="6"
                                        placeholder="Our tutors have been trained to follow your guidance (specific or more general) to get the best results. E.g. Pupil needs to work primarily on his XYZ. It would be useful if you could start by looking at XYZ (especially XYZ) and, once you have covered that, perhaps see if you can give him some guidance on XYZ."
                                    ></textarea>
                                </div>
                            </div>
                            @endforeach
